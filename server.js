/**
 * Express.js API Server for Crypto Classification
 * Ready for deployment to Vercel, Netlify, Railway, etc.
 */
...
if (process.env.NODE_ENV !== 'production' || process.env.VERCEL !== '1') {
    app.listen(PORT, () => {
        console.log(`🚀 Crypto Classification API running on port ${PORT}`);
        console.log(`📡 Health check: http://localhost:${PORT}/health`);
        console.log(`🔍 Classify: POST http://localhost:${PORT}/classify`);
        console.log(`📊 Model info: http://localhost:${PORT}/model_info`);
